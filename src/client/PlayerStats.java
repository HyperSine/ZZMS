...
public class PlayerStats implements Serializable {
    ...
    public void recalcLocalStats(boolean first_login, MapleCharacter chra) {
        ...
        //---------------------------------------套装效果统计
        short HighestBeldSet = 0;
        short HighBeldSet = 0;
        short MediumBeldSet = 0;
        short LowBeldSet = 0;
        short LotharBissSet =0;
        short LionHeartSet = 0;
        short TreasurySeekingLegendSet = 0;
        // --------------------------------
        ...
        while (itera.hasNext()) {
            ...
            //  ------------------ 套装效果统计
            if((equip.getItemId() == 1032220) || (equip.getItemId() == 1113072) || (equip.getItemId() == 1122264) || (equip.getItemId() == 1132243)) LowBeldSet++;
            if((equip.getItemId() == 1032221) || (equip.getItemId() == 1113073) || (equip.getItemId() == 1122265) || (equip.getItemId() == 1132244)) MediumBeldSet++;
            if((equip.getItemId() == 1032222) || (equip.getItemId() == 1113074) || (equip.getItemId() == 1122266) || (equip.getItemId() == 1132245)) HighBeldSet++;
            if((equip.getItemId() == 1032223) || (equip.getItemId() == 1113075) || (equip.getItemId() == 1122267) || (equip.getItemId() == 1132246)) HighestBeldSet++;
            if((equip.getItemId() == 1004159) || (equip.getItemId() == 1042318) || (equip.getItemId() == 1062206) || (equip.getItemId() == 1212097)
                    || (equip.getItemId() == 1222091) || (equip.getItemId() == 1232091) || (equip.getItemId() == 1242097) || (equip.getItemId() == 1242098)
                    || (equip.getItemId() == 1252068) || (equip.getItemId() == 1302311) || (equip.getItemId() == 1312181) || (equip.getItemId() == 1322232) 
                    || (equip.getItemId() == 1332256) || (equip.getItemId() == 1342096) || (equip.getItemId() == 1362117) || (equip.getItemId() == 1372203)
                    || (equip.getItemId() == 1382241) || (equip.getItemId() == 1402228) || (equip.getItemId() == 1402232) || (equip.getItemId() == 1412160)
                    || (equip.getItemId() == 1422167) || (equip.getItemId() == 1432196) || (equip.getItemId() == 1442250) || (equip.getItemId() == 1452234)
                    || (equip.getItemId() == 1462221) || (equip.getItemId() == 1472243) || (equip.getItemId() == 1482198) || (equip.getItemId() == 1492208)
                    || (equip.getItemId() == 1522120) || (equip.getItemId() == 1532126) || (equip.getItemId() == 1542085) || (equip.getItemId() == 1552086)) LotharBissSet++;
            if ((equip.getItemId() == 1003172) ||(equip.getItemId() == 1052314) || (equip.getItemId() == 1072485) || (equip.getItemId() == 1082295) || (equip.getItemId() == 1102275)
                    || (equip.getItemId() == 1152108) || (equip.getItemId() == 1232014) || (equip.getItemId() == 1302152) || (equip.getItemId() == 1312065)
                    || (equip.getItemId() == 1322096) || (equip.getItemId() == 1402095) || (equip.getItemId() == 1412065) || (equip.getItemId() == 1422066)
                    || (equip.getItemId() == 1432086) || (equip.getItemId() == 1442116)) LionHeartSet++;
            if((equip.getItemId() == 1022237) || (equip.getItemId() == 1032246) || (equip.getItemId() == 1112022) || (equip.getItemId() == 1122289)) TreasurySeekingLegendSet++;
            //---------------------
            ...
            if (equip.getState(false) >= 17 || equip.getState(true) >= 17) {
                ...
                for (final int i : potentials) {
                    if (i > 0) {
                        soc = ii.getPotentialInfo(i).get(ii.getReqLevel(equip.getItemId()) / 10 - 1);
                        if (soc != null) {
        ...
        //LotharBissSet 
        //LionHeartSet
        //TreasurySeekingLegendSet
        
        switch(HighestBeldSet){
            case 2:
                localstr += 20;
                localdex += 20;
                localint_ += 20;
...
//                    percent_boss_damage_rate += eff.getBossDamage();
    ...
    private void handleClothsetAdd(MapleCharacter chra){
        ...
        for (int i = 30; i < 50; i++) {
            ...
            if (bx != null && bx.isHyper() && bof > 0) {
                ...
                if (eff != null) {
                    switch (i) {
                        case 30:
                            localstr += eff.getStrX();       //str +50
                            break;
                        case 31:
                            localdex += eff.getDexX();      // Dex +50
                            break;
                        case 32:
                            localint_ += eff.getIntX();     // Int +50
                            break;
                        case 33:
                            localluk += eff.getLukX();     //  Luk +50
                            break;
                        case 34:
                            passive_sharpeye_rate += eff.getCr();     //  暴击率 +10%
                            break;
                        case 35:
                            accuracy += eff.getAccR();                   //命中 +20%
                            break;
                        case 36:                                      //HP +15%
                            percent_hp += eff.getPercentHP();
                            break;
                        case 37:
                            percent_mp += eff.getPercentMP();         //MP +15%
                            break;
                        case 38:
                            localmaxmp += eff.getMaxDemonFury();      //  MaxDF +15%
                            break;
                        case 39:
                            wdef += eff.getWDEFX();                //Physical Defence +500
                            break;
                        case 40:
                            mdef += eff.getMDEFX();               //Magic Defence +500
                            break;
                        case 41:
                            speed += eff.getSpeed();             //Speed +10
                            break;
                        case 42:
                            jump += eff.getJump();               //Jump +10
                            break;
                    }
                }
            }
    ...
    private void handleBuffStats(MapleCharacter chra) {
        ...
        buff = chra.getBuffedValue(MapleBuffStat.INDIE_MHP_R) == null ? 0 : chra.getBuffedValue(MapleBuffStat.INDIE_MHP_R);
        buff2 = chra.getStackBuffedValue(MapleBuffStat.INDIE_MHP_R) == null ? 0 : chra.getStackBuffedValue(MapleBuffStat.INDIE_MHP_R);
       // if(buff2 != null) {
       //     if(buff == null) buff =0;
       //     buff += buff2;
       // }
       // if (buff != null) {
            percent_hp += (buff+buff2);
       // }
