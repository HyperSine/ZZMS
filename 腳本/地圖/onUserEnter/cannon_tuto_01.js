...
function action(mode, type, selection) {
    ...
    if (status <= i++) {
        ...
        ms.getDirectionEffect(2, "Effect/Summon.img/15", [0, 0, 0, 1, 1, 0, 9712735, 0]);
        ...
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/balog/0", [2000, 0, -200, 1, 1, 0, 9712886, 0]);
        ms.getDirectionEffect(1, "", [500]);
    } else if (status === i++) {
        ms.setNPCSpecialAction(9712886, "attack2", 0, false);
        ms.getDirectionEffect(1, "", [1000]);
    } else if (status === i++) {
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/npc/0", [2000, 0, -160, 1, 1, 0, 9712887, 0]);
        ms.setNPCSpecialAction(9712886, "attack1", 0, false);
        ms.getDirectionEffect(1, "", [1000]);
    } else if (status === i++) {
        ms.showEnvironment(5, "Party1/Failed", []);
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/User/0", [2000, 0, -100, 1, 0, 0]);
        ms.getDirectionEffect(1, "", [1000]);
    } else if (status === i++) {
        ...
        ms.setNPCSpecialAction(9712886, "attack2", 0, false);
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/npc/1", [2000, 0, -160, 1, 1, 0, 9712887, 0]);
        ms.getDirectionEffect(1, "", [500]);
        ms.showWZEffect("Effect/Direction4.img/cannonshooter/face02");
    } else if (status === i++) {
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/User/1", [2000, 0, -100, 1, 0, 0]);
        ms.getDirectionEffect(1, "", [1000]);
        ...
        ms.setNPCSpecialAction(9712886, "attack1", 0, false);
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/balog/0", [2000, 0, -200, 1, 1, 0, 9712886, 0]);
        ms.getDirectionEffect(2, "Mob/8150000.img/attack2/info/effect", [0, 0, 0, 1, 1, 0, 9712886, 0]);
        ms.showEnvironment(5, "cannonshooter/Attack1", []);
        ms.getDirectionEffect(1, "", [1000]);
    } else if (status === i++) {
        ms.getDirectionEffect(2, "Mob/8150000.img/attack2/info/hit", [0, 0, 0, 1, 0, 0]);
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/User/2", [2000, 0, -100, 1, 0, 0]);
        ...
        ms.setNPCSpecialAction(9712886, "attack2", 0, false);
        ms.getDirectionEffect(2, "Mob/8130100.img/attack1/info/effect", [0, 0, 0, 1, 1, 0, 9712886, 0]);
        ms.getDirectionEffect(1, "", [500]);
        ms.showWZEffect("Effect/Direction4.img/cannonshooter/face02");
    } else if (status === i++) {
        ms.getDirectionEffect(2, "Mob/8130100.img/attack1/info/hit", [0, 0, 0, 1, 0, 0]);
        ms.showEnvironment(5, "cannonshooter/Attack1", []);
        ms.getDirectionEffect(3, "", [6]);
        ms.getDirectionEffect(1, "", [500]);
        ...
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/balog/1", [2000, 0, -200, 1, 1, 0, 9712886, 0]);
        ms.getDirectionEffect(1, "", [300]);
    } else if (status === i++) {
        ms.getDirectionEffect(3, "", [2]);
        ms.getDirectionEffect(2, "Effect/Direction4.img/effect/cannonshooter/User/3", [2000, 0, -100, 1, 0, 0]);
        ms.getDirectionEffect(1, "", [2000]);
        ms.showWZEffect("Effect/Direction4.img/cannonshooter/face02");
    } else if (status === i++) {
