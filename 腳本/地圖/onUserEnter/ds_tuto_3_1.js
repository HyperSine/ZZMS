...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg1/3", [1500, 0, -100, 1, 1, 0, 2159340, 0]);
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg1/3", [1500, 0, -100, 1, 1, 0, 2159341, 0]);
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg1/3", [1500, 0, -100, 1, 1, 0, 2159342, 0]);
